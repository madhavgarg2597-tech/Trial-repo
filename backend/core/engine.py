...
class GestureEngine:
    def __init__(self):
        ...
        # 3. GESTURE CONFIGURATION (The Connection Point)
        # This dictionary controls which gestures are active
        ...
        # Text Mode State
        self.text_mode_active = False # Renamed to avoid confusion with setting
    ...
    def set_gesture_active(self, gesture_key, is_active):
        """Called by the API to toggle gestures"""
    ...
    def _process_frame(self, frame):
        ...
        if result.hand_landmarks:
            for idx, lm_list in enumerate(result.hand_landmarks):
                ...
                # Velocity
                if idx == 0: # Simplify velocity to first hand
        ...
        # 2. Gesture Logic (Gated by self.gesture_settings)
